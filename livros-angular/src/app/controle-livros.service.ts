...
export class ControleLivrosService {
  livros: Array<Livro> = [
    ...
    { codigo: 3, codEditora: 3, titulo: 'Core Java for the Impatient', resumo: "Readers familiar with Horstmann's original, two-volume 'Core Java' books who are looking for a comprehensive...", autores: ['Cay Horstmann'] }
  ];
